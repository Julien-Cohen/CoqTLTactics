...
Lemma destruct_in_trace_lem {MM1 : Metamodel} {T1} {T2} {BEQ1} {BEQ2} :
  ...
  exists p r i e te,   
    ...
    /\ l = {|
             ...
             TraceLink.target := te
           |} 
    /\ EvalExpressions.evalOutputPatternElementExpr cm p i e = return te .
Proof.
  intros.
  destruct_trace H ; 
...
Lemma destruct_in_modelElements_execute_lem {MM1} {T1} {T2} {BEQ1} {BEQ2} :
  ...
  exists r sp n0 ope,
    ...
    /\ EvalExpressions.evalOutputPatternElementExpr cm sp n0 ope =
         return a.
Proof.
  intros. 
  destruct_in_modelElements_execute H.  
...
Lemma destruct_in_modelLinks_execute_lem {MM1} {T1} {T2} {BEQ1} {BEQ2} :
  ...
  {t: Syntax.Transformation (tc:=Build_TransformationConfiguration MM1 (Build_Metamodel T1 T2 BEQ1 BEQ2))}
    ...
    exists sp r n p te tls,
      ...
      /\ EvalExpressions.evalOutputPatternElementExpr m sp n p =
         return te
...
Ltac exploit_evaloutpat H :=
  ...
  | EvalExpressions.evalOutputPatternElementExpr _ _ _ (Parser.parseOutputPatternElement _) = Some _ =>
