...
(* Moore models as counterexample to prove monotonicity of Stdlib.L *)

(* all tran's src and trg are in m.modelElements *)
...
(* not all tran's src and trg are in m.modelElements *)
Definition Moore_m2 : Model Moore.MM :=
        (Build_Model Moore.MM
            ...
            (
		        ...
		        (TransitionTarget (Build_Glue _ _ (Build_Transition_t 1 "1") (Build_State_t  (Id.Id "S1") "999"))) ::
                nil
            )
        ).

(* m1.links subset of m2.links *)