...
Definition Moore2Mealy_t1 := parse Moore2Mealy_t1'.

Definition Moore2Mealy_t2' :=
    transformation
    [     
      rule "state_Additional"
      from [State_K]
      to [
        ELEM "s" ::: Mealy.State_K  
           fun _ _ s => return convert_state_additional s 
      ];
...
Definition Moore2Mealy_t2 := parse Moore2Mealy_t2'.
