...
Definition evalGuardExpr (r : Rule) (sm: SourceModel) (sp: list SourceElementType) : option bool :=
...
Definition evalOutputPatternLinkExpr
            (sm: SourceModel) (sp: list SourceElementType) (oe: TargetElementType) resolve (iter: nat)
