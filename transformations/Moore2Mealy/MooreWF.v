...
(* FIXME : We should differenciate 1) properties that should be verified by any model of any meta-model, 2) properties that are always verified on models generated by the translator XMI->Stdlib.L, and 3) properties that should be verified by Moore machines. *) 
