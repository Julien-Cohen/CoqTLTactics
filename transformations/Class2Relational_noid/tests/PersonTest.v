...
Require Import transformations.Class2Relational_noid.tests.PersonModel.
...
Fact test_ok :    
    ...
    (Build_Model  
       RelationalMetamodel.MM 
       (RelationalMetamodel.TableElement
          (Build_Table_t "Person")
          
          :: RelationalMetamodel.ColumnElement
          (Build_Column_t "parent") :: nil)
       
       (RelationalMetamodel.Table_columnsLink
          (glue (Build_Table_t "Person")
             with (Build_Column_t "parent" :: nil))
          
          :: RelationalMetamodel.Column_referenceLink
          (glue (Build_Column_t "parent")
             with (Build_Table_t "Person")) :: nil)).
Proof.
  reflexivity.
Qed.
