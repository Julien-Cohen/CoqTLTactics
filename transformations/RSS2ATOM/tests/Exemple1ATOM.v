...
Definition Exemple1ATOM : Model ATOMMetamodel_Metamodel_Instance :=
	(Build_Model ATOMMetamodel_Metamodel_Instance
		(
		...
		(Build_ATOMMetamodel_Object AuthorClass (BuildAuthor (BuildPerson  ""  None   (Some "")) )) :: 
		...
		(Build_ATOMMetamodel_Link AuthorAtomReference (BuildAuthorAtom (BuildAuthor (BuildPerson  ""  None   (Some "")) ) (BuildATOM  "Atoute.org" ""  (Some "")  (Some "")  None   None  ""))) ::
		...
		(Build_ATOMMetamodel_Link ATOMAuthorsReference (BuildATOMAuthors (BuildATOM  "Atoute.org" ""  (Some "")  (Some "")  None   None  "") ((BuildAuthor (BuildPerson  ""  None   (Some "")) ) :: nil ))) ::
