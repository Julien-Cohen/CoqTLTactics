...
Definition InLineTextContent_getContent (i : InLineTextContent) : Content :=
  match i with BuildInLineTextContent content  => content end.

Definition InLineXHTMLContent_getContent (i : InLineXHTMLContent) : Content :=
  match i with BuildInLineXHTMLContent content  => content end.

Definition InLineOtherContent_getContent (i : InLineOtherContent) : Content :=
  match i with BuildInLineOtherContent content  => content end.

Definition OutOfLineContent_getContent (o : OutOfLineContent) : Content :=
  match o with BuildOutOfLineContent content src  => content end.
Definition OutOfLineContent_getSrc (o : OutOfLineContent) :  string :=
  match o with BuildOutOfLineContent content src  => src end.
...
Definition Person_getName (p : Person) :  string :=
  match p with BuildPerson  name uri email  => name end.
Definition Person_getUri (p : Person) :  option  string :=
  match p with BuildPerson  name uri email  => uri end.
Definition Person_getEmail (p : Person) :  option  string :=
  match p with BuildPerson  name uri email  => email end.

Definition Author_getPerson (a : Author) : Person :=
  match a with BuildAuthor person  => person end.

Definition Contributor_getPerson (c : Contributor) : Person :=
  match c with BuildContributor person  => person end.
...
(  option_beq string  beq_string (Person_getUri pe_arg1) (Person_getUri pe_arg2) ) && 
(  option_beq string  beq_string (Person_getEmail pe_arg1) (Person_getEmail pe_arg2) )
.
...
Inductive ATOMMetamodel_Class : Set :=
  ...
  | SourceClass
  | ContentClass
  | InLineTextContentClass
  | InLineXHTMLContentClass
  | InLineOtherContentClass
  | OutOfLineContentClass
  | GeneratorClass
  | CategoryClass
  | LinkClass
  | PersonClass
...
Definition ATOMMetamodel_getTypeByClass (atcl_arg : ATOMMetamodel_Class) : Set :=
  match atcl_arg with
    ...
    | InLineTextContentClass => InLineTextContent
    | InLineXHTMLContentClass => InLineXHTMLContent
    | InLineOtherContentClass => InLineOtherContent
    | OutOfLineContentClass => OutOfLineContent
...
Definition beq_ATOMMetamodel_Object (c1 : ATOMMetamodel_Object) (c2 : ATOMMetamodel_Object) : bool :=
  ...
  | Build_ATOMMetamodel_Object InLineTextContentClass o1, Build_ATOMMetamodel_Object InLineTextContentClass o2 => beq_InLineTextContent o1 o2
  | Build_ATOMMetamodel_Object InLineXHTMLContentClass o1, Build_ATOMMetamodel_Object InLineXHTMLContentClass o2 => beq_InLineXHTMLContent o1 o2
  | Build_ATOMMetamodel_Object InLineOtherContentClass o1, Build_ATOMMetamodel_Object InLineOtherContentClass o2 => beq_InLineOtherContent o1 o2
  | Build_ATOMMetamodel_Object OutOfLineContentClass o1, Build_ATOMMetamodel_Object OutOfLineContentClass o2 => beq_OutOfLineContent o1 o2
  ...
  | Build_ATOMMetamodel_Object PersonClass o1, Build_ATOMMetamodel_Object PersonClass o2 => beq_Person o1 o2
...
Fixpoint ATOMMetamodel_Content_downcastInLineTextContent (co_arg : Content) (l : list ATOMMetamodel_Object) : option InLineTextContent := 
  match l with
	 | Build_ATOMMetamodel_Object InLineTextContentClass (BuildInLineTextContent eSuper ) :: l' => 
		if beq_Content co_arg eSuper then (Some (BuildInLineTextContent eSuper )) else (ATOMMetamodel_Content_downcastInLineTextContent co_arg l')
...
Fixpoint ATOMMetamodel_Content_downcastInLineXHTMLContent (co_arg : Content) (l : list ATOMMetamodel_Object) : option InLineXHTMLContent := 
  match l with
	 | Build_ATOMMetamodel_Object InLineXHTMLContentClass (BuildInLineXHTMLContent eSuper ) :: l' => 
		if beq_Content co_arg eSuper then (Some (BuildInLineXHTMLContent eSuper )) else (ATOMMetamodel_Content_downcastInLineXHTMLContent co_arg l')
...
Fixpoint ATOMMetamodel_Content_downcastInLineOtherContent (co_arg : Content) (l : list ATOMMetamodel_Object) : option InLineOtherContent := 
  match l with
	 | Build_ATOMMetamodel_Object InLineOtherContentClass (BuildInLineOtherContent eSuper ) :: l' => 
		if beq_Content co_arg eSuper then (Some (BuildInLineOtherContent eSuper )) else (ATOMMetamodel_Content_downcastInLineOtherContent co_arg l')
...
Fixpoint ATOMMetamodel_Content_downcastOutOfLineContent (co_arg : Content) (l : list ATOMMetamodel_Object) : option OutOfLineContent := 
  match l with
	 | Build_ATOMMetamodel_Object OutOfLineContentClass (BuildOutOfLineContent eSuper src ) :: l' => 
		if beq_Content co_arg eSuper then (Some (BuildOutOfLineContent eSuper src )) else (ATOMMetamodel_Content_downcastOutOfLineContent co_arg l')
...
Fixpoint ATOMMetamodel_Person_downcastAuthor (pe_arg : Person) (l : list ATOMMetamodel_Object) : option Author := 
  match l with
	 | Build_ATOMMetamodel_Object AuthorClass (BuildAuthor eSuper ) :: l' => 
		if beq_Person pe_arg eSuper then (Some (BuildAuthor eSuper )) else (ATOMMetamodel_Person_downcastAuthor pe_arg l')
...
Fixpoint ATOMMetamodel_Person_downcastContributor (pe_arg : Person) (l : list ATOMMetamodel_Object) : option Contributor := 
  match l with
	 | Build_ATOMMetamodel_Object ContributorClass (BuildContributor eSuper ) :: l' => 
		if beq_Person pe_arg eSuper then (Some (BuildContributor eSuper )) else (ATOMMetamodel_Person_downcastContributor pe_arg l')
